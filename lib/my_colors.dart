...
class MyColors {
  ...
  static const Color posterSubTitle = Color.fromARGB(210, 255, 255, 255);
  ...
  static const Color outlineBorderColor = Color.fromARGB(255, 112, 112, 112);
  static const Color statusBarColorCustom = Color.fromARGB(255, 255, 255, 255);
  static const Color systemNavigationBarColorCustom =
  ...
  static const Color selectedTagsColor = Color.fromARGB(255, 242, 242, 242);
}
...
class GradiantColors {
  ...
  static const List<Color> posterCoverGradiant2 = [
    Color.fromARGB(255, 0, 0, 0),
    Color.fromARGB(0, 0, 0, 0),
  ];
}
